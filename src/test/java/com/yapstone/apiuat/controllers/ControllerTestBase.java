...
import com.yapstone.apiuat.YapstoneStagedOnBoardingServicesClient;
import com.yapstone.apiuat.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static YapstoneStagedOnBoardingServicesClient client;
     ...
     * @return
     */
    protected static YapstoneStagedOnBoardingServicesClient getClient() {
        if (client == null) {
            synchronized (clientSync) {
                if (client == null) {
                    client = new YapstoneStagedOnBoardingServicesClient();
                }
            }
        }
        return client;
